...
import { useConfig } from '@/context.ts';
import { createVisitor } from '@/utils/transform.ts';
import { getName } from './get-name.ts';
import { getSignatureDeclaration } from './get-signature-declaration.ts';
import { getTypeNameFromNode } from './get-type-name-from-node.ts';
import { isSystem } from './rules.ts';
